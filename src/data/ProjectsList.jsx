  ...
  projects: [
    {
      ...
      description:
        "Developed Front-end of a FoodApp where one can ordered food atsiting on table of cafe and restaurant. Learned To develop frontend of an app from Scratch using ReactNative",
      technologies: [
        "React Native",
        "React JS",
        "redux",
      ...
      link:"https://github.com/Sawaijain/FoodAppp",
    },
    {
      name: "Online PG and Hostel Booking",
      description:
        "Developed a react native application which is similar to Airbnb to rent rooms in metro cities.Firebase is used for authentication and database.",
      technologies: [
        "React Native",
        "React JS",
        "REST APIs",
      ...
      link:"https://github.com/Sawaijain/ToLet",
    },
    {
  ...
  
    {
      ...
      description:
        "Develope a website using react js where we can check all the details  the all latest movies and series ",
      technologies: ["React JS", "Material UI","Rest Api","Javascript"],
      link:"https://github.com/Sawaijain/EntertainmentHub",
    },
    // {
